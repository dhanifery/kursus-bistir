<section  class="portfolio section" id="portfolio">
                        ...
                        <img src="<?= base_url()?>/assets/images/home/square2.png" class="shape square2">
                                ...
                                <div class="form-daftar">
                                        ...
                                        <input type="text" class="form-input" name="username_instr" value="<?= $jadwal->nama_paket?> (<?= $jadwal->byk_pertemuan?>)" placeholder="Email" readonly>
                                        <div class="form2" >
                                                <div class="form-2" style="width: 100%;">
                                                        <label for="">Tgl Latihan*</label>
