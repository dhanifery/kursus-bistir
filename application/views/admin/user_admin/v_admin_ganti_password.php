               ...
               <div class="contact-info admin">
                    ...
                    <div class="deskripsi">
                        ...
                        <h5><i class="icon fas fa-exclamation-triangle"></i> Info!</h5>','
                         ...
                         echo form_open_multipart('user/ganti_password/'.$user->id_user) ?>
                              <h3>Form Ganti Password</h3>
                              <input type="password" class="form-input" value="<?= $user->nama_user?>" autocomplete="off" placeholder="Password Lama"  readonly>
                              <div class="form2">
                              ...
                              <div class="form3">
                                   ...
                                   <a  class="btn btn-password" href="<?= base_url('user/update/' .$user->id_user)?>">
                                             <h3>cancel</h3>
                                   </a>
                              </div>
                         </div>
