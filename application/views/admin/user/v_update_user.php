               ...
               <div class="contact-info admin">
                    ...
                    <div class="deskripsi">
                        ...
                        <h5><i class="icon fas fa-exclamation-triangle"></i> Info!</h5>','
                         ...
                         echo form_open_multipart('user/update_user/'.$user->id_user) ?>
                              <h3>Form Edit User</h3>
                              <label for="">Username*</label>
                              <input type="text" class="form-input"  name="nama_user" value="<?= $user->nama_user?>" autocomplete="off" placeholder="Username" >
                              <div class="form2">
                                   <div class="form-2">
                              ...
                              <div class="form3">
                                   ...
                                   <a  class="btn btn-password btn-sm" href="<?= base_url('user/all_user')?>">
                                             <h3>back</h3>
                                   </a>
                              </div>
                         </div>
